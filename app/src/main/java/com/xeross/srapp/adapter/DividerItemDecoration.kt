 ...
 */
class DividerItemDecoration(context: Context, space: Int, resDivider: Int? = null, orientation: Int) : ItemDecoration() {
    /**
    ...
    init {
        if (resDivider == null) {
            ...
            drawable = ContextCompat.getDrawable(context, resDivider);
        }
