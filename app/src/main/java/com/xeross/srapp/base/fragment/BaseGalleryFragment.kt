package com.xeross.srapp.base.fragment
...
@RuntimePermissions
abstract class BaseGalleryFragment<B : ViewBinding> : BaseCategoryFormFragment<B>(), GalleryListener {
    ...
    fun openRationaleForGallery() {
        AlertDialog.Builder(context).setTitle(R.string.permission)
